...
/**
 * This class is used to enable vSphere Kubernetes cluster
 * 
 * @author Kiran Kumar P
 *
 */
public class EnableVsphereKubernetesCluster {
	static {
	...
	public EnableVsphereKubernetesCluster(String vcip, String vcUsername, String vcPassword) {
		this.vcip = vcip;
	...
	public static void main(String[] args) {
		...
		VsphereKubernetesClusterBean clusterBean = new VsphereKubernetesClusterBean(clusterName, sizeHint, networkName,
				...
				storagePolicy);
		new EnableVsphereKubernetesCluster(vcip, vcUsername, vcPassword).enableVsphereKubernetesCluster(clusterBean);
	}
